...
"""Dictionary containing this generations Pokemon moves.

Key value contains corresponding dictionary containing the attributes for the move property.
"""
...
Sequence entries are generated from the moves dictionary. 
Requires Pokemon move be entered within moves colleciton.
"""

NAMES = tuple(dict.keys(MOVES))

"""Generate namedtuples for defined Pokemon move constants.

Uses names tuple containing Pokemon move strings as the instances for each namedtuple.
